...
2. Open the issue using one of our issue templates.
3. Be as detailed as possible - include the project version, what you did, what you expected to happen, and what actually happened.
